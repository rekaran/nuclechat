...
var keymapper = dataManager.model("keymapper", new mongoose.Schema({domain: String, projectId: String, hash: String, key: String, usercount: Number, userlimit: Number, globalcount: Number, limitflag: Boolean, is_live: Boolean, is_debug: Boolean, is_cache: Boolean, is_active: Boolean, wss: Boolean, saveTimestamp: Number, firstmessage_type: String, first_message: String, firstmessages: Object, pushmessage: Object, bot_name: String, company_name: String}));
